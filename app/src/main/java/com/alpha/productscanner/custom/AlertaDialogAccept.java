...
public class AlertaDialogAccept  extends Dialog {

    private Unbinder unbinder;
    private Activity activity;
    private DialogAcceptListener dialogAcceptListener;
    ...
    public AlertaDialogAccept(Activity activity, String title, String message, DialogAcceptListener dialogAcceptListener, boolean isInfo) {
        super(activity);
    ...
    public void activateButtonCancel(boolean activate){
        if (activate)  btnCancel.setVisibility(View.VISIBLE);
