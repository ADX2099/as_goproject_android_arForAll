...
public class AlertaDialogAccept_ViewBinding implements Unbinder {
  private AlertaDialogAccept target;
  ...
  @UiThread
  public AlertaDialogAccept_ViewBinding(AlertaDialogAccept target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AlertaDialogAccept_ViewBinding(final AlertaDialogAccept target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AlertaDialogAccept target = this.target;
